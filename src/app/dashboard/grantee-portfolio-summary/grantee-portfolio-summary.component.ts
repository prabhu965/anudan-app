...
@Component({
    selector: 'app-granteeportfolio-summary',
    templateUrl: './grantee-portfolio-summary.component.html',
    styleUrls: ['./grantee-portfolio-summary.component.css']
})
export class GranteePortfolioSummaryComponent implements OnInit, OnChanges {
